...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-lg-5" style="border: 1px solid grey; padding: 20px; border-radius: 25px;">
                    <div class="contact_form_container">
                        ...
                        <form action="{{ route('stripe.charge') }}" id="payment-form" method="post">
                            @csrf
                            <div class="form-row">
    ...
    <script type="text/javascript">
        ...
        var stripe = Stripe('pk_test_51JxBBQIbU4kXLV49QkcmuvbyrmzlbEY4RMJdnv7Van9fuKAC632VSHTSic28KqCeqy42LezgCMd8xlUIsxRAk28P00lTNVXqtk');
