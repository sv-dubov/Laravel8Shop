...
@section('content')
    ...
    <div class="home">
        ...
        <div class="home_content d-flex flex-column align-items-center justify-content-center">
            <h2 class="home_title">{{ $category->getCategoryTitle() }} products list</h2>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <div class="shop_sidebar">
                        ...
                        <div class="sidebar_section">
                            <div class="sidebar_subtitle brands_subtitle">{{ $category->getCategoryTitle() }} brands</div>
                            <ul class="brands_list">
                                @foreach($brands as $brand)
                                    <li class="brand"><a href="#">{{ $brand->getBrandTitle() }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <div class="product_grid row">
                            ...
                            <!-- Product Item -->
                                <div class="product_item is_new">
                                    ...
                                    <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset($product->image_one) }}" alt="" style="height: 120px; width: 80px;"></div>
                                    <div class="product_content">
                                        ...
                                        <div class="product_name">
                                            <div>
                                                <a href="{{ url('product/details/'.$product->id.'/'.$product->product_name) }}" tabindex="0">{{ $product->product_name  }}</a>
                                            </div>
                                        </div>
                                    </div>
