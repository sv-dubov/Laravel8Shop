        ...
        <div class="container">
            <div class="row">
                <div class="col-5 offset-lg-1">
                    <div class="contact_form_title"><h4>Your order status details</h4></div>
                    <div class="progress">
                        @if($track->status == 0)
                    ...
                    @if($track->status == 0)
                        <h4>Note: Order is under review</h4>
                    @elseif($track->status == 1)
                        <h4>Note: Payment accept is in process</h4>
                    @elseif($track->status == 2)
                        <h4>Note: Order is on the way</h4>
                    @elseif($track->status == 3)
                        <h4>Note: Order was completed</h4>
                    @else
                        <h4>Note: Order was canceled</h4>
                    @endif
                </div>
                <div class="col-5 offset-lg-1">
